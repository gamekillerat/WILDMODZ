...
opd_s sprntf = { SNPRINTF, TOC };
int(*_sprintf)(char *s, size_t n, const char *format, ...) = (int(*)(char*, size_t, const char*, ...))&sprntf;




#pragma region Functions Organized
namespace ADDR
{
	opd_s set_text_font_t = { Addresses::SET_TEXT_FONT, TOC };
	void(*__SET_TEXT_FONT)(int Font) = (void(*)(int))&set_text_font_t;
	
	opd_s set_text_scale_t = { Addresses::SET_TEXT_SCALE, TOC };
	void(*__SET_TEXT_SCALE)(float x, float y) = (void(*)(float, float))&set_text_scale_t;

	opd_s set_text_colour_t = { Addresses::SET_TEXT_COLOUR, TOC };
	void(*__SET_TEXT_COLOUR)(int r, int g, int b, int a) = (void(*)(int, int, int, int))&set_text_colour_t;

	opd_s set_text_wrap_t = { Addresses::SET_TEXT_WRAP, TOC };
	void(*__SET_TEXT_WRAP)(float x, float y) = (void(*)(float, float))&set_text_wrap_t;

	opd_s set_text_centre_t = { Addresses::SET_TEXT_CENTRE, TOC };
	void(*__SET_TEXT_CENTER)(bool a) = (void(*)(bool))&set_text_centre_t;

	opd_s set_text_dropshadow_t = { Addresses::SET_TEXT_DROPSHADOW, TOC };
	void(*__SET_TEXT_DROPSHADOW)(int p0, int p1, int p2, int p3, int p4) = (void(*)(int, int, int, int, int))&set_text_dropshadow_t;

	opd_s set_text_outline_t = { Addresses::SET_TEXT_OUTLINE, TOC };
	void(*__SET_TEXT_OUTLINE)() = (void(*)())&set_text_outline_t;

	opd_s add_text_component_string_t = { Addresses::ADD_TEXT_COMPONENT_STRING, TOC };
	void(*__ADD_TEXT_COMPONENT_STRING)(const char *text) = (void(*)(const char *))&add_text_component_string_t;

	opd_s draw_text_t = { Addresses::DRAW_TEXT, TOC };
	void(*__DRAW_TEXT)(float x, float y) = (void(*)(float, float))&draw_text_t;

	opd_s draw_rect_t = { Addresses::DRAW_RECT, TOC };
	void(*__DRAW_RECT)(float x1, float y1, float x2, float y2, int r, int g, int b, int a) = (void(*)(float, float, float, float, int, int, int, int))&draw_rect_t;
	void(*___DRAW_RECT)(float* xyz1, float* xyz2, int r, int g, int b, int a) = (void(*)(float* xyz1, float* xyz2, int, int, int, int))&draw_rect_t;

	opd_s draw_line_t = { Addresses::DRAW_LINE, TOC };
	void(*__DRAW_LINE)(float* xyz1, float* xyz2, int r, int g, int b, int a) = (void(*)(float* xyz1, float* xyz2, int, int, int, int))&draw_line_t;
	
	//opd_s CREATE_VEHICLE_t = { Addresses::CREATE_VEHICLE, TOC };
	...
	opd_s STAT_SET_INT_t = { Addresses::STAT_SET_INT, TOC };
	opd_s STAT_SET_BOOL_t = { Addresses::STAT_SET_BOOL, TOC };
	opd_s STAT_SET_FLOAT_t = { Addresses::STAT_SET_FLOAT, TOC };
	opd_s SET_ENTITY_AS_MISSION_ENTITY_t = { Addresses::SET_ENTITY_AS_MISSION_ENTITY, TOC };
	opd_s DELETE_VEHICLE_t = { Addresses::DELETE_VEHICLE, TOC };
	opd_s NETWORK_EARN_FROM_ROCKSTAR_t = { Addresses::NETWORK_EARN_FROM_ROCKSTAR, TOC };
	opd_s GET_ENTITY_HEALTH_t = { Addresses::GET_ENTITY_HEALTH, TOC };
	opd_s GET_ENTITY_MAX_HEALTH_t = { Addresses::GET_ENTITY_MAX_HEALTH, TOC };
	opd_s HAS_ACHIEVEMENT_BEEN_PASSED_t = { Addresses::HAS_ACHIEVEMENT_BEEN_PASSED, TOC };
	opd_s GIVE_ACHIEVEMENT_TO_PLAYER_t = { Addresses::GIVE_ACHIEVEMENT_TO_PLAYER, TOC };
	opd_s GET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t = { Addresses::GET_VEHICLE_CUSTOM_PRIMARY_COLOUR, TOC };
	opd_s STRING_TO_INT_t = { Addresses::STRING_TO_INT, TOC };
	opd_s snprintf_stub = { Addresses::Snprintf, TOC };
	opd_s create_ambient_pickup_t = { Addresses::unk_0xE51B4C5A, TOC };
	opd_s PRINT_TEXT_TYPE_t = { Addresses::PRINT_TEXT_TYPE, TOC };
	opd_s PRINT_TEXT_TIME_t = { Addresses::PRINT_TEXT_TIME, TOC };
	opd_s NOTIFICATION_TYPE_t = { Addresses::NOTIFICATION_TYPE, TOC };
	opd_s NOTIFICATION_TEXT_t = { Addresses::NOTIFICATION_TEXT, TOC };
	opd_s NOTIFICATION_SHOW_t = { Addresses::NOTIFICATION_SHOW, TOC };
	opd_s ADD_EXPLOSION_t = { Addresses::ADD_EXPLOSION, TOC };
	opd_s SET_POLICE_IGNORE_PLAYER_t = { Addresses::SET_POLICE_IGNORE_PLAYER, TOC };
	opd_s _SET_ENTITY_INVINCIBLE = { Addresses::SET_ENTITY_INVINCIBLE, TOC };
	opd_s SET_PED_INFINITE_AMMO_CLIP_t = { Addresses::SET_PED_INFINITE_AMMO_CLIP, TOC };
	opd_s SET_MODEL_AS_NO_LONGER_NEEDED_t = { Addresses::SET_MODEL_AS_NO_LONGER_NEEDED, TOC };
	opd_s IS_PED_IN_ANY_VEHICLE_t = { Addresses::IS_PED_IN_ANY_VEHICLE, TOC };
	opd_s GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS_t = { Addresses::GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS, TOC };
	opd_s SET_PED_INTO_VEHICLE_t = { Addresses::SET_PED_INTO_VEHICLE, TOC };
	opd_s GET_ENTITY_HEADING_t = { Addresses::GET_ENTITY_HEADING, TOC };
	opd_s IS_VEHICLE_SEAT_FREE_t = { Addresses::IS_VEHICLE_SEAT_FREE, TOC };
	opd_s play_sound_frontend_t = { Addresses::PLAY_SOUND_FRONTEND, TOC };
	opd_s REQUEST_MODEL_t = { Addresses::REQUEST_MODEL, TOC };
	opd_s HAS_MODEL_LOADED_t = { Addresses::HAS_MODEL_LOADED, TOC };
	opd_s CLONE_PED_t = { Addresses::CLONE_PED, TOC };
	opd_s SET_VEHICLE_FIXED_t = { Addresses::SET_VEHICLE_FIXED, TOC };
	opd_s GET_VEHICLE_PED_IS_USING_t = { Addresses::GET_VEHICLE_PED_IS_USING, TOC };
	opd_s get_player_ped_t = { Addresses::GET_PLAYER_PED, TOC };
	opd_s disable_control_action_t = { Addresses::DISABLE_CONTROL_ACTION, TOC };
	opd_s enable_all_control_actions_t = { Addresses::ENABLE_ALL_CONTROL_ACTIONS, TOC };
	opd_s SET_VEHICLE_BOOST_ACTIVE_t = { Addresses::SET_VEHICLE_BOOST_ACTIVE, TOC };
	opd_s SET_PLAYER_WANTED_LEVEL_t = { Addresses::SET_PLAYER_WANTED_LEVEL, TOC };
	opd_s SET_MAX_WANTED_LEVEL_t = { Addresses::SET_MAX_WANTED_LEVEL, TOC };
	opd_s GET_MAX_WANTED_LEVEL_t = { Addresses::GET_MAX_WANTED_LEVEL, TOC };
	opd_s REMOVE_ALL_PED_WEAPONS_t = { Addresses::REMOVE_ALL_PED_WEAPONS, TOC };
	opd_s GIVE_WEAPON_TO_PED_t = { Addresses::GIVE_WEAPON_TO_PED, TOC };
	opd_s GIVE_DELAYED_WEAPON_TO_PED_t = { Addresses::GIVE_DELAYED_WEAPON_TO_PED, TOC };
	opd_s GET_ENTITY_SPEED_t = { Addresses::GET_ENTITY_SPEED, TOC };
	opd_s GET_ENTITY_COORDS_t = { Addresses::GET_ENTITY_COORDS, TOC };
	opd_s set_input_exlcusive_t = { Addresses::SET_INPUT_EXCLUSIVE, TOC };
	opd_s _add_text_component_string = { Addresses::ADD_TEXT_COMPONENT_STRING, TOC };
	opd_s set_text_entry_t = { Addresses::SET_TEXT_ENTRY, TOC };
	opd_s get_player_name_t = { Addresses::GET_PLAYER_NAME, TOC };
	opd_s CREATE_VEHICLE_t = { Addresses::CREATE_VEHICLE, TOC };
	opd_s SET_ENTITY_COORDS_t = { Addresses::SET_ENTITY_COORDS, TOC };
	opd_s SET_ENTITY_COORDS_NO_OFFSET_t = { Addresses::SET_ENTITY_COORDS_NO_OFFSET, TOC };
	opd_s GET_VEHICLE_PED_IS_IN_t = { Addresses::GET_VEHICLE_PED_IS_IN, TOC };
	opd_s CLEAR_PLAYER_WANTED_LEVEL_t = { Addresses::CLEAR_PLAYER_WANTED_LEVEL, TOC };
	opd_s IS_PLAYER_PRESSING_HORN_t = { Addresses::IS_PLAYER_PRESSING_HORN, TOC };
	opd_s CREATE_CAM_t = { Addresses::CREATE_CAM, TOC };
	opd_s SET_CAM_ACTIVE_t = { Addresses::SET_CAM_ACTIVE, TOC };
	opd_s ATTACH_CAM_TO_PED_BONE_t = { Addresses::ATTACH_CAM_TO_PED_BONE, TOC };
	opd_s RENDER_SCRIPT_CAMS_t = { Addresses::RENDER_SCRIPT_CAMS, TOC };
	opd_s GET_INDEX_OF_CURRENT_LEVEL_t = { Addresses::GET_INDEX_OF_CURRENT_LEVEL, TOC };
	opd_s DESTROY_CAM_t = { Addresses::DESTROY_CAM, TOC };
	opd_s CLEAR_AREA_t = { Addresses::CLEAR_AREA, TOC };
	opd_s CLEAR_AREA_OF_COPS_t = { Addresses::CLEAR_AREA_OF_COPS, TOC };
	opd_s CLEAR_AREA_OF_OBJECTS_t = { Addresses::CLEAR_AREA_OF_OBJECTS, TOC };
	opd_s CLEAR_AREA_OF_VEHICLES_t = { Addresses::CLEAR_AREA_OF_VEHICLES, TOC };
	opd_s CLEAR_AREA_OF_PEDS_t = { Addresses::CLEAR_AREA_OF_PEDS, TOC };
	opd_s CLEAR_AREA_OF_PROJECTILES_t = { Addresses::CLEAR_AREA_OF_PROJECTILES, TOC };
	opd_s SET_CAM_ROT_t = { Addresses::SET_CAM_ROT, TOC };
	opd_s GET_GAMEPLAY_CAM_ROT_t = { Addresses::GET_GAMEPLAY_CAM_ROT, TOC };
	opd_s CREATE_PED_t = { Addresses::CREATE_PED, TOC };
	opd_s GET_PLAYER_GROUP_t = { Addresses::GET_PLAYER_GROUP, TOC };
	opd_s SET_PED_AS_GROUP_LEADER_t = { Addresses::SET_PED_AS_GROUP_LEADER, TOC };
	opd_s SET_PED_AS_GROUP_MEMBER_t = { Addresses::SET_PED_AS_GROUP_MEMBER, TOC };
	opd_s SET_PED_COMBAT_ABILITY_t = { Addresses::SET_PED_COMBAT_ABILITY, TOC };
	opd_s REMOVE_PED_FROM_GROUP_t = { Addresses::REMOVE_PED_FROM_GROUP, TOC };
	opd_s SET_PED_CAN_SWITCH_WEAPON_t = { Addresses::SET_PED_CAN_SWITCH_WEAPON, TOC };
	opd_s SET_MOBILE_PHONE_RADIO_STATE_t = { Addresses::SET_MOBILE_PHONE_RADIO_STATE, TOC };
	opd_s PLAYER_PED_ID_t = { Addresses::PLAYER_PED_ID, TOC };
	opd_s PLAYER_ID_t = { Addresses::PLAYER_ID, TOC };
	opd_s IS_MODEL_VALID_t = { Addresses::IS_MODEL_VALID, TOC };
	opd_s DETACH_ENTITY_FROM_ENTITY_t = { Addresses::DETACH_ENTITY_FROM_ENTITY, TOC };
	opd_s IS_PED_MALE_t = { Addresses::IS_PED_MALE, TOC };
	opd_s SET_PED_RANDOM_COMPONENT_VARIATION_t = { Addresses::SET_PED_RANDOM_COMPONENT_VARIATION, TOC };
	opd_s REQUEST_ANIM_SET_t = { Addresses::REQUEST_ANIM_SET, TOC };
	opd_s HAS_ANIM_SET_LOADED_t = { Addresses::HAS_ANIM_SET_LOADED, TOC };
	opd_s SET_PED_MOVEMENT_CLIPSET_t = { Addresses::SET_PED_MOVEMENT_CLIPSET, TOC };
	opd_s GET_PED_BONE_INDEX_t = { Addresses::GET_PED_BONE_INDEX, TOC };
	opd_s CREATE_OBJECT_t = { Addresses::CREATE_OBJECT, TOC };
	opd_s IS_PED_SHOOTING_t = { Addresses::IS_PED_SHOOTING, TOC };
	opd_s GET_PED_LAST_WEAPON_IMPACT_COORD_t = { Addresses::GET_PED_LAST_WEAPON_IMPACT_COORD, TOC };
	opd_s IS_PLAYER_TARGETTING_ENTITY_t = { Addresses::IS_PLAYER_TARGETTING_ENTITY, TOC };
	opd_s GET_CLOCK_HOURS_t = { Addresses::GET_CLOCK_HOURS, TOC };
	opd_s NETWORK_OVERRIDE_CLOCK_TIME_t = { Addresses::NETWORK_OVERRIDE_CLOCK_TIME, TOC };
	opd_s IS_SYSTEM_UI_BEING_DISPLAYED_t = { Addresses::IS_SYSTEM_UI_BEING_DISPLAYED, TOC };
	opd_s GET_ONSCREEN_KEYBOARD_RESULT_t = { Addresses::GET_ONSCREEN_KEYBOARD_RESULT, TOC };
	opd_s DISPLAY_ONSCREEN_KEYBOARD_t = { Addresses::DISPLAY_ONSCREEN_KEYBOARD, TOC };
	opd_s UPDATE_ONSCREEN_KEYBOARD_t = { Addresses::UPDATE_ONSCREEN_KEYBOARD, TOC };
	opd_s SET_VEHICLE_RPM_MULTIPLIER_t = { Addresses::_0xE943B09C, TOC };
	opd_s CLEAR_PED_BLOOD_DAMAGE_t = { Addresses::CLEAR_PED_BLOOD_DAMAGE, TOC };
	opd_s RESET_PED_VISIBLE_DAMAGE_t = { Addresses::RESET_PED_VISIBLE_DAMAGE, TOC };
	opd_s DRAW_LIGHT_WITH_RANGE_t = { Addresses::DRAW_LIGHT_WITH_RANGE, TOC };
	opd_s GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS_t = { Addresses::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS, TOC };
	opd_s GET_CLOSEST_VEHICLE_t = { Addresses::GET_CLOSEST_VEHICLE, TOC };
	opd_s SET_OVERRIDE_WEATHER_t = { Addresses::SET_OVERRIDE_WEATHER, TOC };
	opd_s SET_VEHICLE_TYRES_CAN_BURST_t = { Addresses::SET_VEHICLE_TYRES_CAN_BURST, TOC };
	opd_s REMOVE_VEHICLE_MOD_t = { Addresses::REMOVE_VEHICLE_MOD, TOC };
	opd_s SET_PLAYER_INVINCIBLE_t = { Addresses::SET_PLAYER_INVINCIBLE, TOC };
	opd_s DOES_BLIP_EXIST_t = { Addresses::DOES_BLIP_EXIST, TOC };
	opd_s GET_BLIP_COORDS_t = { Addresses::GET_BLIP_COORDS, TOC };
	opd_s GET_ENTITY_MODEL_t = { Addresses::GET_ENTITY_MODEL, TOC };
	opd_s GET_MODEL_DIMENSIONS_t = { Addresses::GET_MODEL_DIMENSIONS, TOC };
	opd_s SHOOT_SINGLE_BULLET_BETWEEN_COORDS_t = { Addresses::SHOOT_SINGLE_BULLET_BETWEEN_COORDS, TOC };
	opd_s IS_PED_ON_FOOT_t = { Addresses::IS_PED_ON_FOOT, TOC };
	opd_s GET_VEHICLE_ENGINE_HEALTH_t = { Addresses::GET_VEHICLE_ENGINE_HEALTH, TOC };
	opd_s DRAW_SPRITE_t = { Addresses::DRAW_SPRITE, TOC };
	opd_s REQUEST_STREAMED_TEXTURE_DICT_t = { Addresses::REQUEST_STREAMED_TEXTURE_DICT, TOC };
	opd_s HAS_STREAMED_TEXTURE_DICT_LOADED_t = { Addresses::HAS_STREAMED_TEXTURE_DICT_LOADED, TOC };
	opd_s SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE_t = { Addresses::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE, TOC };
	opd_s SET_VEHICLE_MOD_KIT_t = { Addresses::SET_VEHICLE_MOD_KIT, TOC };
	opd_s SET_VEHICLE_COLOURS_t = { Addresses::SET_VEHICLE_COLOURS, TOC };
	opd_s SET_VEHICLE_TYRE_SMOKE_COLOR_t = { Addresses::SET_VEHICLE_TYRE_SMOKE_COLOR, TOC };
	opd_s SET_VEHICLE_NUMBER_PLATE_TEXT_t = { Addresses::SET_VEHICLE_NUMBER_PLATE_TEXT, TOC };
	opd_s SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX_t = { Addresses::SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX, TOC };
	opd_s TOGGLE_VEHICLE_MOD_t = { Addresses::TOGGLE_VEHICLE_MOD, TOC };
	opd_s SET_VEHICLE_MOD_t = { Addresses::SET_VEHICLE_MOD, TOC };
	opd_s SET_VEHICLE_WHEEL_TYPE_t = { Addresses::SET_VEHICLE_WHEEL_TYPE, TOC };
	opd_s SET_VEHICLE_WINDOW_TINT_t = { Addresses::SET_VEHICLE_WINDOW_TINT, TOC };
	opd_s NETWORK_GET_NETWORK_ID_FROM_ENTITY_t = { Addresses::NETWORK_GET_NETWORK_ID_FROM_ENTITY, TOC };
	opd_s NETWORK_DOES_NETWORK_ID_EXIST_t = { Addresses::NETWORK_DOES_NETWORK_ID_EXIST, TOC };
	opd_s DOES_ENTITY_EXIST_t = { Addresses::DOES_ENTITY_EXIST, TOC };
	opd_s IS_ENTITY_A_VEHICLE_t = { Addresses::IS_ENTITY_A_VEHICLE, TOC };
	opd_s NETWORK_HAS_CONTROL_OF_ENTITY_t = { Addresses::NETWORK_HAS_CONTROL_OF_ENTITY, TOC };
	opd_s APPLY_FORCE_TO_ENTITY_t = { Addresses::APPLY_FORCE_TO_ENTITY, TOC };
	opd_s SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT_t = { Addresses::SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT, TOC };
	opd_s SET_PED_CAN_RAGDOLL_t = { Addresses::SET_PED_CAN_RAGDOLL, TOC };
	opd_s GET_RANDOM_INT_IN_RANGE_t = { Addresses::GET_RANDOM_INT_IN_RANGE, TOC };
	opd_s SET_VEHICLE_ON_GROUND_PROPERLY_t = { Addresses::SET_VEHICLE_ON_GROUND_PROPERLY, TOC };
	opd_s SET_VEHICLE_REDUCE_GRIP_t = { Addresses::SET_VEHICLE_REDUCE_GRIP, TOC };
	opd_s ATTACH_ENTITY_TO_ENTITY_t = { Addresses::ATTACH_ENTITY_TO_ENTITY, TOC };
	opd_s DETACH_ENTITY_t = { Addresses::DETACH_ENTITY, TOC };
	opd_s IS_ENTITY_ATTACHED_t = { Addresses::IS_ENTITY_ATTACHED, TOC };
	opd_s GET_GROUND_Z_FOR_3D_COORD_t = { Addresses::GET_GROUND_Z_FOR_3D_COORD, TOC };
	opd_s REQUEST_COLLISION_AT_COORD_t = { Addresses::REQUEST_COLLISION_AT_COORD, TOC };
	opd_s GET_FIRST_BLIP_INFO_ID_t = { Addresses::GET_FIRST_BLIP_INFO_ID, TOC };
	opd_s IS_WAYPOINT_ACTIVE_t = { Addresses::IS_WAYPOINT_ACTIVE, TOC };
	opd_s _0x825423C2_t = { Addresses::_0x825423C2, TOC };
	opd_s SET_GRAVITY_LEVEL_t = { Addresses::SET_GRAVITY_LEVEL, TOC };
	opd_s SET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t = { Addresses::SET_VEHICLE_CUSTOM_PRIMARY_COLOUR, TOC };
	opd_s SET_VEHICLE_CUSTOM_SECONDARY_COLOUR_t = { Addresses::SET_VEHICLE_CUSTOM_SECONDARY_COLOUR, TOC };
	opd_s GIVE_PLAYER_RAGDOLL_CONTROL_t = { Addresses::GIVE_PLAYER_RAGDOLL_CONTROL, TOC };
	opd_s SET_PED_RAGDOLL_ON_COLLISION_t = { Addresses::SET_PED_RAGDOLL_ON_COLLISION, TOC };
	opd_s DELETE_ENTITY_t = { Addresses::DELETE_ENTITY, TOC };
	opd_s DELETE_PED_t = { Addresses::DELETE_PED, TOC };
	opd_s SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS_t = { Addresses::SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS, TOC };
	opd_s SET_VEHICLE_DOORS_LOCKED_t = { Addresses::SET_VEHICLE_DOORS_LOCKED, TOC };
	opd_s SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER_t = { Addresses::SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER, TOC };
	opd_s GET_VEHICLE_DOORS_LOCKED_FOR_PLAYER_t = { Addresses::GET_VEHICLE_DOORS_LOCKED_FOR_PLAYER, TOC };
	opd_s SET_VEHICLE_FORWARD_SPEED_t = { Addresses::SET_VEHICLE_FORWARD_SPEED, TOC };
	opd_s SET_ENTITY_ROTATION_t = { Addresses::SET_ENTITY_ROTATION, TOC };
	opd_s REQUEST_IPL_t = { Addresses::REQUEST_IPL, TOC };
	opd_s REMOVE_IPL_t = { Addresses::REMOVE_IPL, TOC };
	opd_s IS_IPL_ACTIVE_t = { Addresses::IS_IPL_ACTIVE, TOC };
	opd_s IS_MODEL_IN_CDIMAGE_t = { Addresses::IS_MODEL_IN_CDIMAGE, TOC };
	opd_s SET_PLAYER_MODEL_t = { Addresses::SET_PLAYER_MODEL, TOC };
	opd_s SET_ENTITY_VISIBLE_t = { Addresses::SET_ENTITY_VISIBLE, TOC };
	opd_s IS_ENTITY_VISIBLE_t = { Addresses::IS_ENTITY_VISIBLE, TOC };
	opd_s SET_VEHICLE_DEFORMATION_FIXED_t = { Addresses::SET_VEHICLE_DEFORMATION_FIXED, TOC };
	opd_s SET_VEHICLE_DIRT_LEVEL_t = { Addresses::SET_VEHICLE_DIRT_LEVEL, TOC };
	opd_s GET_PLAYER_RADIO_STATION_INDEX_t = { Addresses::GET_PLAYER_RADIO_STATION_INDEX, TOC };
	opd_s SET_RADIO_TO_STATION_INDEX_t = { Addresses::SET_RADIO_TO_STATION_INDEX, TOC };
	opd_s SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY_t = { Addresses::SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY, TOC };
	opd_s TASK_PLAY_ANIM_t = { Addresses::TASK_PLAY_ANIM, TOC };
	opd_s HAS_ANIM_DICT_LOADED_t = { Addresses::HAS_ANIM_DICT_LOADED, TOC };
	opd_s NETWORK_REQUEST_CONTROL_OF_ENTITY_t = { Addresses::NETWORK_REQUEST_CONTROL_OF_ENTITY, TOC };
	opd_s REQUEST_ANIM_DICT_t = { Addresses::REQUEST_ANIM_DICT, TOC };
	opd_s CLEAR_PED_TASKS_IMMEDIATELY_t = { Addresses::CLEAR_PED_TASKS_IMMEDIATELY, TOC };
	opd_s NETWORK_GET_HOST_OF_SCRIPT_t = { Addresses::NETWORK_GET_HOST_OF_SCRIPT, TOC };
	opd_s NETWORK_SESSION_KICK_PLAYER_t = { Addresses::NETWORK_SESSION_KICK_PLAYER, TOC };
	opd_s DO_SCREEN_FADE_OUT_t = { Addresses::DO_SCREEN_FADE_OUT, TOC };
	opd_s DO_SCREEN_FADE_IN_t = { Addresses::DO_SCREEN_FADE_IN, TOC };
	opd_s IS_SCREEN_FADED_OUT_t = { Addresses::IS_SCREEN_FADED_OUT, TOC };
	opd_s IS_SCREEN_FADED_IN_t = { Addresses::IS_SCREEN_FADED_IN, TOC };
	opd_s IS_SCREEN_FADING_IN_t = { Addresses::IS_SCREEN_FADING_IN, TOC };
	opd_s IS_SCREEN_FADING_OUT_t = { Addresses::IS_SCREEN_FADING_OUT, TOC };
	opd_s SET_VEHICLE_UNDRIVEABLE_t = { Addresses::SET_VEHICLE_UNDRIVEABLE, TOC };
	opd_s GET_TIME_SINCE_LAST_DEATH_t = { Addresses::GET_TIME_SINCE_LAST_DEATH, TOC };
	opd_s GET_TIME_SINCE_LAST_ARREST_t = { Addresses::GET_TIME_SINCE_LAST_ARREST, TOC };
	opd_s GET_TIME_SINCE_PLAYER_HIT_VEHICLE_t = { Addresses::GET_TIME_SINCE_PLAYER_HIT_VEHICLE, TOC };
	opd_s GET_TIME_SINCE_PLAYER_HIT_PED_t = { Addresses::GET_TIME_SINCE_PLAYER_HIT_PED, TOC };
	opd_s NETWORK_IS_PLAYER_TALKING_t = { Addresses::NETWORK_IS_PLAYER_TALKING, TOC };
	opd_s ADD_OWNED_EXPLOSION_t = { Addresses::ADD_OWNED_EXPLOSION, TOC };
	opd_s GET_ENTITY_PITCH_t = { Addresses::GET_ENTITY_PITCH, TOC };
	opd_s GET_ENTITY_ROLL_t = { Addresses::GET_ENTITY_ROLL, TOC };
	opd_s FREEZE_ENTITY_POSITION_t = { Addresses::FREEZE_ENTITY_POSITION, TOC };
	opd_s SET_ENTITY_HEADING_t = { Addresses::SET_ENTITY_HEADING, TOC };
	opd_s SET_PED_PROP_INDEX_t = { Addresses::SET_PED_PROP_INDEX, TOC };
	opd_s SET_PED_COMPONENT_VARIATION_t = { Addresses::SET_PED_COMPONENT_VARIATION, TOC };
	opd_s CLEAR_ALL_PED_PROPS_t = { Addresses::CLEAR_ALL_PED_PROPS, TOC };
	opd_s CLEAR_PED_DECORATIONS_t = { Addresses::CLEAR_PED_DECORATIONS, TOC };
	opd_s _0x8CD3E487_t = { Addresses::_0x8CD3E487, TOC };
	opd_s SET_ENTITY_COLLISION_t = { Addresses::SET_ENTITY_COLLISION, TOC };
	opd_s SET_PED_ALERTNESS_t = { Addresses::SET_PED_ALERTNESS, TOC };
	opd_s SET_PED_AS_ENEMY_t = { Addresses::SET_PED_AS_ENEMY, TOC };
	opd_s TASK_COMBAT_PED_t = { Addresses::TASK_COMBAT_PED, TOC };
	opd_s SET_PED_KEEP_TASK_t = { Addresses::SET_PED_KEEP_TASK, TOC };
	opd_s SET_PED_COMBAT_RANGE_t = { Addresses::SET_PED_COMBAT_RANGE, TOC };
	opd_s GET_ENTITY_ROTATION_t = { Addresses::GET_ENTITY_ROTATION, TOC };
	opd_s GET_ENTITY_FORWARD_VECTOR_t = { Addresses::GET_ENTITY_FORWARD_VECTOR, TOC };
	opd_s CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR_t = { Addresses::CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR, TOC };
	opd_s CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR_t = { Addresses::CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR, TOC };
	opd_s SET_VEHICLE_DOOR_OPEN_t = { Addresses::SET_VEHICLE_DOOR_OPEN, TOC };
	opd_s SET_VEHICLE_DOOR_SHUT_t = { Addresses::SET_VEHICLE_DOOR_SHUT, TOC };
	opd_s GET_GAMEPLAY_CAM_COORD_t = { Addresses::GET_GAMEPLAY_CAM_COORD, TOC };
	opd_s NETWORK_ADD_FRIEND_t = { Addresses::NETWORK_ADD_FRIEND, TOC };
	opd_s TASK_VEHICLE_DRIVE_TO_COORD_t = { Addresses::TASK_VEHICLE_DRIVE_TO_COORD, TOC };
	opd_s CREATE_RANDOM_PED_AS_DRIVER_t = { Addresses::CREATE_RANDOM_PED_AS_DRIVER, TOC };
	opd_s GET_VEHICLE_NUMBER_OF_PASSENGERS_t = { Addresses::GET_VEHICLE_NUMBER_OF_PASSENGERS, TOC };
	opd_s DOES_CAM_EXIST_t = { Addresses::DOES_CAM_EXIST, TOC };
	opd_s SET_ENTITY_CAN_BE_DAMAGED_t = { Addresses::SET_ENTITY_CAN_BE_DAMAGED, TOC };
	void(*ATTACH_ENTITY_TO_ENTITYo)(int entity, int entity2, int a, int b, int a1, int b1, int c, int d, int c1, int e, int f) = (void(*)(int, int, int, int, int, int, int, int, int, int, int))&ATTACH_ENTITY_TO_ENTITY_t;

	void(*__task_combat_ped)(int SpawnedPed, int CurrentPedID, int a, int b) = (void(*)(int, int, int, int))&TASK_COMBAT_PED_t;
	void(*set_entity_can_be_damaged)(int entity, int active) = (void(*)(int, int))&SET_ENTITY_CAN_BE_DAMAGED_t;
	void(*SHOOT_SINGLE_BULLET_BETWEEN_COORDS)(Vector3 start, Vector3 end, int a, int b, int hashweapon, int myid, int d, int e, float speed) = (void(*)(Vector3, Vector3, int, int, int, int, int, int, float))&SHOOT_SINGLE_BULLET_BETWEEN_COORDS_t;

	void(*REQUEST_IPL)(const char*) = (void(*)(const char*))&REQUEST_IPL_t;
	void(*REMOVE_IPL)(const char*) = (void(*)(const char*))&REMOVE_IPL_t;
	bool(*IS_IPL_ACTIVE)(const char*) = (bool(*)(const char*))&IS_IPL_ACTIVE_t;
	bool(*__DOES_CAM_EXIST)(int cam) = (bool(*)(int))&DOES_CAM_EXIST_t;
	void(*__SET_VEHICLE_BOOST_ACTIVE)(int VehicleID, int activate, int b) = (void(*)(int, int, int))&SET_VEHICLE_BOOST_ACTIVE_t;
	bool(*__GET_VEHICLE_NUMBER_OF_PASSENGERS)(int vehID) = (bool(*)(int))&GET_VEHICLE_NUMBER_OF_PASSENGERS_t;
	void(*__TASK_VEHICLE_DRIVE_TO_COORD)(int VehID, int veh, float* coords, int p1, int vehhash, int p2, int p3, int p4, int p5) = (void(*)(int, int, float*, int, int, int, int, int, int))&TASK_VEHICLE_DRIVE_TO_COORD_t;
	int(*__CREATE_RANDOM_PED_AS_DRIVER)(int VehID, bool toggle) = (int(*)(int, bool))&CREATE_RANDOM_PED_AS_DRIVER_t;
	int(*__snprintf)(char * s, size_t n, const char * format, ...) = (int(*)(char*, size_t, const char*, ...))&snprintf_stub;
	bool(*__STRING_TO_INT)(const char* String, int * out) = (bool(*)(const char*, int*))&STRING_TO_INT_t;
	void(*__GET_VEHICLE_CUSTOM_PRIMARY_COLOUR)(int VehicleID, int* R, int* G, int* B) = (void(*)(int, int*, int*, int*))&GET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t;
	...
	int(*__PRINT_TEXT_TYPE)(const char* p1) = (int(*)(const char *))&PRINT_TEXT_TYPE_t;
	int(*__PRINT_TEXT_TIME)(int p1) = (int(*)(int))&PRINT_TEXT_TIME_t;
	void(*__NOTIFICATION_TYPE)(char* Type) = (void(*)(char*))&NOTIFICATION_TYPE_t;
	void(*__NOTIFICATION_TEXT)(char* string) = (void(*)(char*))&NOTIFICATION_TEXT_t;
	void(*__NOTIFICATION_SHOW)(int  Milisecounds, int one) = (void(*)(int, int))&NOTIFICATION_SHOW_t;
	void(*SET_POLICE_IGNORE_PLAYER)(uint PLAYER_ID, bool Enabled) = (void(*)(uint, bool))&SET_POLICE_IGNORE_PLAYER;
	void(*__SET_ENTITY_INVINCIBLE)(int p1, bool p2) = (void(*)(int, bool))&_SET_ENTITY_INVINCIBLE;
	void(*__SET_PED_INFINITE_AMMO_CLIP)(uint32_t PLAYER_ID, bool Enabled) = (void(*)(uint32_t, bool))&SET_PED_INFINITE_AMMO_CLIP_t;
	void(*__ADD_EXPLOSION)(Vector3 *pos, int type, float dist, bool a, bool b, float c) = (void(*)(Vector3 *pos, int, float, bool, bool, float))&ADD_EXPLOSION_t;
	...
	bool(*__IS_PED_IN_ANY_VEHICLE)(uint pedid, int Zero) = (bool(*)(uint, int))&IS_PED_IN_ANY_VEHICLE_t;
	void(*__SET_MODEL_AS_NO_LONGER_NEEDED)(uint32_t Hash) = (void(*)(uint32_t))&SET_MODEL_AS_NO_LONGER_NEEDED_t;
	void(*__SET_PED_INTO_VEHICLE)(int Ped, int Vehicle, int Seat) = (void(*)(int, int, int))&SET_PED_INTO_VEHICLE_t;
	int(*__GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS)(int Vehicle) = (int(*)(int))&GET_VEHICLE_MAX_NUMBER_OF_PASSENGERS_t;
	bool(*__IS_VEHICLE_SEAT_FREE)(int Vehicle, int seat) = (bool(*)(int, int))&IS_VEHICLE_SEAT_FREE_t;
	int(*__CLONE_PED)(int Ped, int d, int a, int) = (int(*)(int, int, int, int))&CLONE_PED_t;
	void(*__PLAY_SOUND_FRONTEND)(int a, const char* SoundName, const char* SoundSetName) = (void(*)(int, const char*, const char*))&play_sound_frontend_t;
	void(*__REQUEST_MODEL)(uint32_t Hash) = (void(*)(uint32_t))&REQUEST_MODEL_t;
	bool(*__HAS_MODEL_LOADED)(uint32_t Hash) = (bool(*)(uint32_t))&HAS_MODEL_LOADED_t;
	void(*__SET_VEHICLE_FIXED)(int VehicleID) = (void(*)(int))&SET_VEHICLE_FIXED_t;
	uint(*__GET_VEHICLE_PED_IS_USING)(int PLAYER_ID) = (uint(*)(int))&GET_VEHICLE_PED_IS_USING_t;
	uint(*__GET_PLAYER_PED)(int Player) = (uint(*)(int))&get_player_ped_t;
	void(*__DISABLE_CONTROL_ACTION)(int p1, int p2) = (void(*)(int, int))&disable_control_action_t;
	void(*__ENABLE_ALL_CONTROL_ACTIONS)(int p1) = (void(*)(int))&enable_all_control_actions_t;
	void(*__SET_INPUT_EXCLUSIVE)(int p1, int p2) = (void(*)(int, int))&set_input_exlcusive_t;
	void(*___ADD_TEXT_COMPONENT_STRING)(const char *text) = (void(*)(const char *))&_add_text_component_string;
	void(*__PRINT_TEXT_TEXT)(const char *text) = (void(*)(const char *))&_add_text_component_string;
	char*(*__GET_PLAYER_NAME)(int pedid) = (char*(*)(int))&get_player_name_t;
	void(*___SET_TEXT_ENTRY)(const char* p1) = (void(*)(const char *))&set_text_entry_t;
	int(*__CREATE_VEHICLE)(int VehicleHash, Vector3 *Pos, float Heading, int One, int Zero) = (int(*)(int, Vector3*Pos, float, int, int))&CREATE_VEHICLE_t;
	void(*__SET_ENTITY_COORDS)(int id, Vector3 *c, int zero, int _zero, int zero_, int one) = (void(*)(int, Vector3 *c, int, int, int, int))&SET_ENTITY_COORDS_t;
	void(*__SET_ENTITY_COORDS_NO_OFFSET)(int id, Vector3 *c, int zero, int _zero, int one) = (void(*)(int, Vector3 *c, int, int, int))&SET_ENTITY_COORDS_NO_OFFSET_t;
	Vector3(*__GET_ENTITY_COORDS)(int id, bool) = (Vector3(*)(int, bool))&GET_ENTITY_COORDS_t;
	uint(*__GET_VEHICLE_PED_IS_IN)(uint PedID, int Zero) = (uint(*)(uint, int))&GET_VEHICLE_PED_IS_IN_t;
	float(*__GET_ENTITY_SPEED)(int entity) = (float(*)(int))&GET_ENTITY_SPEED_t;
	void(*__GIVE_DELAYED_WEAPON_TO_PED)(uint Ped, uint WeaponHash, int Ammo, int One) = (void(*)(uint, uint, int, int))&GIVE_DELAYED_WEAPON_TO_PED_t;
	void(*__GIVE_WEAPON_TO_PED)(uint Ped, uint WeaponHash, int Ammo, int One) = (void(*)(uint, uint, int, int))&GIVE_WEAPON_TO_PED_t;
	void(*__REMOVE_ALL_PED_WEAPONS)(uint Ped) = (void(*)(uint))&REMOVE_ALL_PED_WEAPONS_t;
	int(*__GET_MAX_WANTED_LEVEL)() = (int(*)())&GET_MAX_WANTED_LEVEL_t;
	void(*__SET_MAX_WANTED_LEVEL)(int level) = (void(*)(int))&SET_MAX_WANTED_LEVEL_t;
	void(*__SET_PLAYER_WANTED_LEVEL)(int id, int value) = (void(*)(int, int))&SET_PLAYER_WANTED_LEVEL_t;
	void(*__CLEAR_PLAYER_WANTED_LEVEL)(uint32_t PLAYER_ID) = (void(*)(uint32_t))&CLEAR_PLAYER_WANTED_LEVEL_t;
	bool(*__IS_MODEL_IN_CDIMAGE)(uint ModelHash) = (bool(*)(uint))&IS_MODEL_IN_CDIMAGE_t;
	void(*__SET_PLAYER_MODEL)(uint Ped, uint Hash) = (void(*)(uint, uint))&SET_PLAYER_MODEL_t;
	void(*__SET_ENTITY_VISIBLE)(uint Ped, bool Toggle) = (void(*)(uint, bool))&SET_ENTITY_VISIBLE_t;
	bool(*__IS_ENTITY_VISIBLE)(uint Ped) = (bool(*)(uint))&IS_ENTITY_VISIBLE_t;
	void(*__SET_VEHICLE_DEFORMATION_FIXED)(uint Vehicle) = (void(*)(uint))&SET_VEHICLE_DEFORMATION_FIXED_t;
	void(*__SET_VEHICLE_DIRT_LEVEL)(uint Vehicle, int dirtLevel) = (void(*)(uint, int))&SET_VEHICLE_DIRT_LEVEL_t;
	bool(*__IS_PLAYER_PRESSING_HORN)(int Player) = (bool(*)(int))&IS_PLAYER_PRESSING_HORN_t;
	int(*__PLAYER_PED_ID)() = (int(*)())&PLAYER_PED_ID_t;
	int(*__PLAYER_ID)() = (int(*)())&PLAYER_ID_t;
	void(*__SET_MOBILE_PHONE_RADIO_STATE)(int enable) = (void(*)(int))&SET_MOBILE_PHONE_RADIO_STATE_t;
	int(*__GET_PLAYER_RADIO_STATION_INDEX)() = (int(*)())&GET_PLAYER_RADIO_STATION_INDEX_t;
	void(*__SET_RADIO_TO_STATION_INDEX)(int station) = (void(*)(int station))&SET_RADIO_TO_STATION_INDEX_t;
	void(*__SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY)(int enable) = (void(*)(int station))&SET_MOBILE_RADIO_ENABLED_DURING_GAMEPLAY_t;
	int(*__TASK_PLAY_ANIM)(int ee, const char* b, const char* f, float x, float y, int cv, int ew, int qa, int zx, int fg, int gh) = (int(*)(int, const char*, const char*, float, float, int, int, int, int, int, int))&TASK_PLAY_ANIM_t;
	int(*__HAS_ANIM_DICT_LOADED)(const char* hasanim2) = (int(*)(const char *))&HAS_ANIM_DICT_LOADED_t;
	bool(*__NETWORK_REQUEST_CONTROL_OF_ENTITY)(int Entity) = (bool(*)(int))&NETWORK_REQUEST_CONTROL_OF_ENTITY_t;
	int(*__REQUEST_ANIM_DICT)(const char* anim) = (int(*)(const char*))&REQUEST_ANIM_DICT_t;
	int(*__CLEAR_PED_TASKS_IMMEDIATELY)(int p1) = (int(*)(int))&CLEAR_PED_TASKS_IMMEDIATELY_t;
	void(*__SET_VEHICLE_ON_GROUND_PROPERLY)(int VehicleID) = (void(*)(int))&SET_VEHICLE_ON_GROUND_PROPERLY_t;
	void(*__SET_VEHICLE_REDUCE_GRIP)(int car, bool enable) = (void(*)(int, bool))&SET_VEHICLE_REDUCE_GRIP_t;
	void(*__ATTACH_ENTITY_TO_ENTITY)(int Entity, int Entity2, int BoneIndex, Vector3 *O1, Vector3 *O2, int Zero, float Solid, float Dirty, int _Zero, int Two, int One) = (void(*)(int, int, int, Vector3 *O1, Vector3 *O2, int, float, float, int, int, int))&ATTACH_ENTITY_TO_ENTITY_t;
	void(*__DETACH_ENTITY)(uint Entity, bool True, bool Truee) = (void(*)(uint, bool, bool))&DETACH_ENTITY_t;
	bool(*__IS_ENTITY_ATTACHED)(uint entity) = (bool(*)(uint))&IS_ENTITY_ATTACHED_t;
	void(*__GET_GROUND_Z_FOR_3D_COORD)(Vector3 *Coords, float *ptr) = (void(*)(Vector3 *Coords, float *ptr))&GET_GROUND_Z_FOR_3D_COORD_t;
	void(*__REQUEST_COLLISION_AT_COORD)(Vector3 *Coords) = (void(*)(Vector3 *Coords))&REQUEST_COLLISION_AT_COORD_t;
	int(*__GET_FIRST_BLIP_INFO_ID)(int Blip) = (int(*)(int))&GET_FIRST_BLIP_INFO_ID_t;
	bool(*__IS_WAYPOINT_ACTIVE)() = (bool(*)())&IS_WAYPOINT_ACTIVE_t;
	void(*___0x825423C2)(int player_id, float speed) = (void(*)(int, float))&_0x825423C2_t;
	void(*__SET_GRAVITY_LEVEL)(int level) = (void(*)(int))&SET_GRAVITY_LEVEL_t;
	void(*__SET_VEHICLE_CUSTOM_PRIMARY_COLOUR)(uint VehicleID, int R, int G, int B) = (void(*)(uint, int, int, int))&SET_VEHICLE_CUSTOM_PRIMARY_COLOUR_t;
	int(*__SET_VEHICLE_CUSTOM_SECONDARY_COLOUR)(int VehicleID, int R, int G, int B) = (int(*)(int, int, int, int))&SET_VEHICLE_CUSTOM_SECONDARY_COLOUR_t;
	void(*__GIVE_PLAYER_RAGDOLL_CONTROL)(int Player, bool en) = (void(*)(int, bool))&GIVE_PLAYER_RAGDOLL_CONTROL_t;
	void(*__SET_PED_RAGDOLL_ON_COLLISION)(int Player, bool en) = (void(*)(int, bool))&SET_PED_RAGDOLL_ON_COLLISION_t;
	void(*__DELETE_ENTITY)(int *Handle) = (void(*)(int *Handle))&DELETE_ENTITY_t;
	void(*__DELETE_PED)(int *Handle) = (void(*)(int *Handle))&DELETE_PED_t;
	void(*__DELETE_VEHICLE)(int *Handle) = (void(*)(int *Handle))&DELETE_VEHICLE_t;
	void(*__SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS)(uint VehicleID, bool State) = (void(*)(uint, bool))&SET_VEHICLE_DOORS_LOCKED_FOR_ALL_PLAYERS_t;
	void(*__SET_VEHICLE_DOORS_LOCKED)(int vehID, int State, int unk) = (void(*)(int, int, int))&SET_VEHICLE_DOORS_LOCKED_t;
	void(*__SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER)(uint VehicleID, uint SelectedPlayerID, bool State) = (void(*)(uint, uint, bool))&SET_VEHICLE_DOORS_LOCKED_FOR_PLAYER_t;
	bool(*__GET_VEHICLE_DOORS_LOCKED_FOR_PLAYER)(uint VehicleID, uint SelectedPlayerID) = (bool(*)(uint, uint))&GET_VEHICLE_DOORS_LOCKED_FOR_PLAYER_t;
	void(*__SET_VEHICLE_FORWARD_SPEED)(int VehicleID, float Speed) = (void(*)(int, float))&SET_VEHICLE_FORWARD_SPEED_t;
	void(*__SET_ENTITY_ROTATION)(int Entity, Vector3* Orien, int two, bool True) = (void(*)(int, Vector3*, int, bool))&SET_ENTITY_ROTATION_t;
	void(*__REQUEST_IPL)(const char*) = (void(*)(const char*))&REQUEST_IPL_t;
	void(*__REMOVE_IPL)(const char*) = (void(*)(const char*))&REMOVE_IPL_t;
	bool(*__IS_IPL_ACTIVE)(const char*) = (bool(*)(const char*))&IS_IPL_ACTIVE_t;
	void(*__SET_VEHICLE_MOD_KIT)(uint VehID, int ModKit) = (void(*)(uint, int))&SET_VEHICLE_MOD_KIT_t;
	void(*__SET_VEHICLE_COLOURS)(uint VehID, int color1, int color2) = (void(*)(uint, int, int))&SET_VEHICLE_COLOURS_t;
	void(*__SET_VEHICLE_TYRE_SMOKE_COLOR)(int Vehid, int r, int g, int b) = (void(*)(int, int, int, int))&SET_VEHICLE_TYRE_SMOKE_COLOR_t;
	void(*__SET_VEHICLE_NUMBER_PLATE_TEXT)(uint VehID, const char* PlateText) = (void(*)(uint, const char*))&SET_VEHICLE_NUMBER_PLATE_TEXT_t;
	void(*__SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX)(uint VehID, int PlateIndex) = (void(*)(uint, int))&SET_VEHICLE_NUMBER_PLATE_TEXT_INDEX_t;
	void(*__TOGGLE_VEHICLE_MOD)(uint VehID, int ModType, int ModLevel) = (void(*)(uint, int, int))&TOGGLE_VEHICLE_MOD_t;
	void(*__SET_VEHICLE_MOD)(uint VehID, int arg1, int arg2, int arg3) = (void(*)(uint, int, int, int))&SET_VEHICLE_MOD_t;
	void(*__SET_VEHICLE_WHEEL_TYPE)(uint VehID, int WheelType) = (void(*)(uint, int))&SET_VEHICLE_WHEEL_TYPE_t;
	void(*__SET_VEHICLE_WINDOW_TINT)(uint VehID, int Tint) = (void(*)(uint, int))&SET_VEHICLE_WINDOW_TINT_t;
	int(*__NETWORK_GET_NETWORK_ID_FROM_ENTITY)(uint VehID) = (int(*)(uint))&NETWORK_GET_NETWORK_ID_FROM_ENTITY_t;
	bool(*__NETWORK_DOES_NETWORK_ID_EXIST)(uint VehID) = (bool(*)(uint))&NETWORK_DOES_NETWORK_ID_EXIST_t;
	bool(*__DOES_ENTITY_EXIST)(uint VehID) = (bool(*)(uint))&DOES_ENTITY_EXIST_t;
	bool(*__IS_ENTITY_A_VEHICLE)(uint VehID) = (bool(*)(uint))&IS_ENTITY_A_VEHICLE_t;
	bool(*__NETWORK_HAS_CONTROL_OF_ENTITY)(uint VehID) = (bool(*)(uint))&NETWORK_HAS_CONTROL_OF_ENTITY_t;
	void(*__APPLY_FORCE_TO_ENTITY)(int p0, int p1, Vector3 *Force, Vector3 *Pos, int p8, int p9, int p10, int p11, int p12, int p13) = (void(*)(int, int, Vector3 *Force, Vector3 *Pos, int, int, int, int, int, int))&APPLY_FORCE_TO_ENTITY_t;
	void(*__SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT)(int PedID, bool activate) = (void(*)(int, bool))&SET_PED_CAN_RAGDOLL_FROM_PLAYER_IMPACT_t;
	void(*__SET_PED_CAN_RAGDOLL)(int PedID, bool activate) = (void(*)(int, bool))&SET_PED_CAN_RAGDOLL_t;
	int(*__GET_RANDOM_INT_IN_RANGE)(int lowest, int highest) = (int(*)(int, int))&GET_RANDOM_INT_IN_RANGE_t;
	void(*__DRAW_LIGHT_WITH_RANGE)(Vector3 *Loc, int R, int G, int B, float Intensity, float Range) = (void(*)(Vector3 *Loc, int, int, int, float, float))&DRAW_LIGHT_WITH_RANGE_t;
	Vector3(*__GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS)(int VehID, float* coords) = (Vector3(*)(int, float* coords))&GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS_t;
	Vector3(*GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS)(int ped, Vector3 coords) = (Vector3(*)(int, Vector3))&GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS_t;
	int(*__GET_CLOSEST_VEHICLE)(Vector3 *Coords, float unk, int unk2, int unk3) = (int(*)(Vector3 *Coords, float, int, int))&GET_CLOSEST_VEHICLE_t;
	void(*__SET_OVERRIDE_WEATHER)(const char* Weather) = (void(*)(const char*))&SET_OVERRIDE_WEATHER_t;
	void(*__SET_VEHICLE_TYRES_CAN_BURST)(int vehicleID, int toggle) = (void(*)(int, int))&SET_VEHICLE_TYRES_CAN_BURST_t;
	void(*__REMOVE_VEHICLE_MOD)(int vehicleID, int modtype) = (void(*)(int, int))&REMOVE_VEHICLE_MOD_t;
	void(*__SET_PLAYER_INVINCIBLE)(int Pedid, bool toggle) = (void(*)(int, bool))&SET_PLAYER_INVINCIBLE_t;
	bool(*__DOES_BLIP_EXIST)(int Blip) = (bool(*)(int))&DOES_BLIP_EXIST_t;
	Vector3(*__GET_BLIP_COORDS)(int Blip) = (Vector3(*)(int))&GET_BLIP_COORDS_t;
	int(*__GET_ENTITY_MODEL)(int Entity) = (int(*)(int))&GET_ENTITY_MODEL_t;
	void(*__GET_MODEL_DIMENSIONS)(int Model, float * min, float * max) = (void(*)(int, float*, float*))&GET_MODEL_DIMENSIONS_t;
	void(*__SHOOT_SINGLE_BULLET_BETWEEN_COORDS)(float* start, float* end, int _999, int zero, int hashweapon, int PedAttacker, int one, int _one, float speed) = (void(*)(float* start, float* end, int, int, int, int, int, int, float))&SHOOT_SINGLE_BULLET_BETWEEN_COORDS_t;
	void(*___SHOOT_SINGLE_BULLET_BETWEEN_COORDS)(float a, float b, float c, float d, float e, float f, int g, int h, int i, int j, int k, int l, float m) = (void(*)(float, float, float, float, float, float, int, int, int, int, int, int, float))&SHOOT_SINGLE_BULLET_BETWEEN_COORDS_t;
	bool(*__IS_PED_ON_FOOT)(int Ped) = (bool(*)(int))&IS_PED_ON_FOOT_t;
	float(*__GET_VEHICLE_ENGINE_HEALTH)(int VehID) = (float(*)(int))&GET_VEHICLE_ENGINE_HEALTH_t;
	void(*__DRAW_SPRITE)(char* StreamedTexture, char* TextureName, float X, float Y, float Width, float Height, float Rotation, int R, int G, int B, int A) = (void(*)(char*, char*, float, float, float, float, float, int, int, int, int))&DRAW_SPRITE_t;
	void(*__REQUEST_STREAMED_TEXTURE_DICT)(char * StreamedTexture, bool False) = (void(*)(char*, bool))&REQUEST_STREAMED_TEXTURE_DICT_t;
	bool(*__HAS_STREAMED_TEXTURE_DICT_LOADED)(char * StreamedTexture) = (bool(*)(char*))&HAS_STREAMED_TEXTURE_DICT_LOADED_t;
	void(*__SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE)(int Ped, bool Toggle) = (void(*)(int, bool))&SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE_t;
	int(*__IS_MODEL_VALID)(int hash) = (int(*)(int))&IS_MODEL_VALID_t;
	void(*__DETACH_ENTITY_FROM_ENTITY)(int entity, int entity2, int a) = (void(*)(int, int, int))&DETACH_ENTITY_FROM_ENTITY_t;
	bool(*__IS_PED_MALE)(int PedID) = (bool(*)(int))&IS_PED_MALE_t;
	void(*__SET_PED_RANDOM_COMPONENT_VARIATION)(int PedID) = (void(*)(int))&SET_PED_RANDOM_COMPONENT_VARIATION_t;
	void(*__REQUEST_ANIM_SET)(char* Anim) = (void(*)(char*))&REQUEST_ANIM_SET_t;
	bool(*__HAS_ANIM_SET_LOADED)(char* Anim) = (bool(*)(char*))&HAS_ANIM_SET_LOADED_t;
	void(*__SET_PED_MOVEMENT_CLIPSET)(int Ped, char* MovSet, int unk) = (void(*)(int, char*, int))&SET_PED_MOVEMENT_CLIPSET_t;
	int(*__GET_PED_BONE_INDEX)(int PedID, int Bone) = (int(*)(int, int))&GET_PED_BONE_INDEX_t;
	bool(*__IS_PED_SHOOTING)(int Ped) = (bool(*)(int))&IS_PED_SHOOTING_t;
	int(*GET_PED_LAST_WEAPON_IMPACT_COORD2)(int PedID, float* Coords) = (int(*)(int, float*))&GET_PED_LAST_WEAPON_IMPACT_COORD_t;//GET_MODEL_DIMENSIONS
	bool(*__GET_PED_LAST_WEAPON_IMPACT_COORD)(int Ped, float*Co) = (bool(*)(int, float*))&GET_PED_LAST_WEAPON_IMPACT_COORD_t;
	bool(*__IS_PLAYER_TARGETTING_ENTITY)(int Player, int Entity) = (bool(*)(int, int))&IS_PLAYER_TARGETTING_ENTITY_t;
	int(*__GET_CLOCK_HOURS)() = (int(*)())&GET_CLOCK_HOURS_t;
	void(*__NETWORK_OVERRIDE_CLOCK_TIME)(int Hours, int Minutes, int Seconds) = (void(*)(int, int, int))&NETWORK_OVERRIDE_CLOCK_TIME_t;
	bool(*__IS_SYSTEM_UI_BEING_DISPLAYED)() = (bool(*)())&IS_SYSTEM_UI_BEING_DISPLAYED_t;
	char*(*__GET_ONSCREEN_KEYBOARD_RESULT)() = (char*(*)())&GET_ONSCREEN_KEYBOARD_RESULT_t;
	int(*__DISPLAY_ONSCREEN_KEYBOARD)(int language, const char *gxtName, const char *unk1, const char *defaultText, const char *unk2, const char* unk3, const char* unk4, int maxMessageLen) = (int(*)(int, const char*, const char*, const char*, const char*, const char*, const char*, int))&DISPLAY_ONSCREEN_KEYBOARD_t;
	int(*__UPDATE_ONSCREEN_KEYBOARD)() = (int(*)())&UPDATE_ONSCREEN_KEYBOARD_t;
	void(*__SET_VEHICLE_RPM_MULTIPLIER)(int VehID, float Multipl) = (void(*)(int, float))&SET_VEHICLE_RPM_MULTIPLIER_t;
	void(*__CLEAR_PED_BLOOD_DAMAGE)(int PedID) = (void(*)(int))&CLEAR_PED_BLOOD_DAMAGE_t;
	void(*__RESET_PED_VISIBLE_DAMAGE)(int PedID) = (void(*)(int))&RESET_PED_VISIBLE_DAMAGE_t;
	int(*__CREATE_CAM)(const char * name, bool unk) = (int(*)(const char*, bool))&CREATE_CAM_t;
	void(*__SET_CAM_ACTIVE)(int cam, bool unk) = (void(*)(int, bool))&SET_CAM_ACTIVE_t;
	void(*__ATTACH_CAM_TO_PED_BONE)(int cam, int Ped, int boneid, Vector3 *Pos, bool unk) = (void(*)(int, int, int, Vector3 *Pos, bool))&ATTACH_CAM_TO_PED_BONE_t;
	void(*___ATTACH_CAM_TO_PED_BONE)(int cam, int Ped, int boneid, Vector3, bool unk) = (void(*)(int, int, int, Vector3, bool))&ATTACH_CAM_TO_PED_BONE_t;
	int(*get_index_of_current_level)() = (int(*)())&GET_INDEX_OF_CURRENT_LEVEL_t;
	void(*__RENDER_SCRIPT_CAMS)(int f, int a, int b, int c, int d) = (void(*)(int, int, int, int, int))&RENDER_SCRIPT_CAMS_t;
	void(*__DESTROY_CAM)(int Client, int Button) = (void(*)(int, int))&DESTROY_CAM_t;
	void(*__CLEAR_AREA)(Vector3 *Pos, float Radius, bool unk) = (void(*)(Vector3 *Pos, float, bool))&CLEAR_AREA_t;
	void(*__CLEAR_AREA_OF_COPS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_COPS_t;
	void(*__CLEAR_AREA_OF_OBJECTS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_OBJECTS_t;
	void(*__CLEAR_AREA_OF_VEHICLES)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_VEHICLES_t;
	void(*__CLEAR_AREA_OF_PEDS)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_PEDS_t;
	void(*__CLEAR_AREA_OF_PROJECTILES)(Vector3 *Pos, float Radius) = (void(*)(Vector3 *Pos, float))&CLEAR_AREA_OF_PROJECTILES_t;
	void(*__SET_CAM_ROT)(int Cam, Vector3 *Rot, int unk) = (void(*)(int, Vector3 *Rot, int))&SET_CAM_ROT_t;
	void(*___SET_CAM_ROT)(int cam, Vector3, int mode) = (void(*)(int, Vector3, int))&SET_CAM_ROT_t;

	Vector3(*__GET_GAMEPLAY_CAM_ROT)(int Index) = (Vector3(*)(int))&GET_GAMEPLAY_CAM_ROT_t;
	int(*__CREATE_PED)(int e, int hash, Vector3 *Coords, float a, int b, int c) = (int(*)(int, int, Vector3 *Coords, float, int, int))&CREATE_PED_t;
	int(*__GET_PLAYER_GROUP)(int PlayerID) = (int(*)(int))&GET_PLAYER_GROUP_t;
	void(*__SET_PED_AS_GROUP_LEADER)(int Ped, int Group) = (void(*)(int, int))&SET_PED_AS_GROUP_LEADER_t;
	void(*__SET_PED_AS_GROUP_MEMBER)(int Ped, int Group) = (void(*)(int, int))&SET_PED_AS_GROUP_MEMBER_t;
	void(*__SET_PED_COMBAT_ABILITY)(int Ped, int Value) = (void(*)(int, int))&SET_PED_COMBAT_ABILITY_t;
	void(*__SET_PED_CAN_SWITCH_WEAPON)(int Ped, bool Value) = (void(*)(int, bool))&SET_PED_CAN_SWITCH_WEAPON_t;
	void(*__REMOVE_PED_FROM_GROUP)(int Ped) = (void(*)(int))&REMOVE_PED_FROM_GROUP_t;
	int(*___STAT_SET_INT)(int hash, int value) = (int(*)(int, int))&STAT_SET_INT_t;
	int(*__STAT_SET_INT)(int hash, int value, int number) = (int(*)(int, int, int))&STAT_SET_INT_t;
	void(*__STAT_SET_BOOL)(int Hash, int Value, int Number) = (void(*)(int, int, int))&STAT_SET_BOOL_t;
	void(*___STAT_SET_BOOL)(int Hash, int Value) = (void(*)(int, int))&STAT_SET_BOOL_t;
	void(*__STAT_SET_FLOAT)(int Hash, float Value, int Number) = (void(*)(int, float, int))&STAT_SET_FLOAT_t;
	void(*___STAT_SET_FLOAT)(int Hash, float Value) = (void(*)(int, float))&STAT_SET_FLOAT_t;
	void(*__SET_ENTITY_AS_MISSION_ENTITY)(int EntityHandle, int unk1, int unk2) = (void(*)(int, int, int))&SET_ENTITY_AS_MISSION_ENTITY_t;
	void(*__NETWORK_EARN_FROM_ROCKSTAR)(int Amount) = (void(*)(int))&NETWORK_EARN_FROM_ROCKSTAR_t;
	int(*__GET_ENTITY_HEALTH)(int Entity) = (int(*)(int))&GET_ENTITY_HEALTH_t;
	int(*__GET_ENTITY_MAX_HEALTH)(int Entity) = (int(*)(int))&GET_ENTITY_MAX_HEALTH_t;
	bool(*__HAS_ACHIEVEMENT_BEEN_PASSED)(int AchID) = (bool(*)(int))&HAS_ACHIEVEMENT_BEEN_PASSED_t;
	void(*__GIVE_ACHIEVEMENT_TO_PLAYER)(int AchID) = (void(*)(int))&GIVE_ACHIEVEMENT_TO_PLAYER_t;
	int(*__NETWORK_GET_HOST_OF_SCRIPT)(const char* script, int unk, int unk2) = (int(*)(const char*, int, int))&NETWORK_GET_HOST_OF_SCRIPT_t;
	void(*__NETWORK_SESSION_KICK_PLAYER)(int PlayerID) = (void(*)(int))&NETWORK_SESSION_KICK_PLAYER_t;
	void(*__DO_SCREEN_FADE_OUT)(int FadeTime) = (void(*)(int))&DO_SCREEN_FADE_OUT_t;
	void(*__DO_SCREEN_FADE_IN)(int FadeTime) = (void(*)(int))&DO_SCREEN_FADE_IN_t;
	bool(*__IS_SCREEN_FADING_OUT)() = (bool(*)())&IS_SCREEN_FADING_OUT_t;
	bool(*__IS_SCREEN_FADING_IN)() = (bool(*)())&IS_SCREEN_FADING_IN_t;
	bool(*__IS_SCREEN_FADED_OUT)() = (bool(*)())&IS_SCREEN_FADED_OUT_t;
	bool(*__IS_SCREEN_FADED_IN)() = (bool(*)())&IS_SCREEN_FADED_IN_t;
	void(*__SET_VEHICLE_UNDRIVEABLE)(int VehID, bool toggle) = (void(*)(int, bool))&SET_VEHICLE_UNDRIVEABLE_t;
	int(*__GET_TIME_SINCE_LAST_DEATH)() = (int(*)())&GET_TIME_SINCE_LAST_DEATH_t;
	int(*__GET_TIME_SINCE_LAST_ARREST)() = (int(*)())&GET_TIME_SINCE_LAST_ARREST_t;
	int(*__GET_TIME_SINCE_PLAYER_HIT_VEHICLE)(int Player) = (int(*)(int))&GET_TIME_SINCE_PLAYER_HIT_VEHICLE_t;
	int(*__GET_TIME_SINCE_PLAYER_HIT_PED)(int Player) = (int(*)(int))&GET_TIME_SINCE_PLAYER_HIT_PED_t;
	bool(*__NETWORK_IS_PLAYER_TALKING)(int Player) = (bool(*)(int))&NETWORK_IS_PLAYER_TALKING_t;
	int(*__CREATE_OBJECT)(uint32_t Hash, Vector3 *Coords, int a, int b, int c, int d, int e) = (int(*)(uint32_t, Vector3 *Coords, int, int, int, int, int))&CREATE_OBJECT_t;
	int(*CREATE_OBJECTo)(int Hash, Vector3 Coords, int a, int b, int c) = (int(*)(int, Vector3, int, int, int))&CREATE_OBJECT_t;
	void(*set_entity_rotation)(int ENTITY, Vector3, int d, int e) = (void(*)(int, Vector3, int, int))&SET_ENTITY_ROTATION_t;
	float(*__GET_ENTITY_PITCH)(int Handle) = (float(*)(int))&GET_ENTITY_PITCH_t;
	float(*__GET_ENTITY_HEADING)(int Handle) = (float(*)(int))&GET_ENTITY_HEADING_t;
	float(*__GET_ENTITY_ROLL)(int Handle) = (float(*)(int))&GET_ENTITY_ROLL_t;
	void(*__FREEZE_ENTITY_POSITION)(uint Handle, bool Toggle) = (void(*)(uint, bool))&FREEZE_ENTITY_POSITION_t;
	void(*__SET_ENTITY_HEADING)(uint Handle, float Heading) = (void(*)(uint Handle, float))&SET_ENTITY_HEADING_t;
	void(*__SET_PED_PROP_INDEX)(uint Ped, int Family, int Model, int Texture) = (void(*)(uint, int, int, int))&SET_PED_PROP_INDEX_t;
	void(*__SET_PED_COMPONENT_VARIATION)(uint Ped, int Family, int Model, int Texture) = (void(*)(uint, int, int, int))&SET_PED_COMPONENT_VARIATION_t;
	void(*__CLEAR_ALL_PED_PROPS)(uint Ped) = (void(*)(uint))&CLEAR_ALL_PED_PROPS_t;
	void(*__CLEAR_PED_DECORATIONS)(uint Ped) = (void(*)(uint))&CLEAR_PED_DECORATIONS_t;
	void(*___0x8CD3E487)(uint Ped, uint32_t Hash1, uint32_t Hash2) = (void(*)(uint, uint32_t, uint32_t))&_0x8CD3E487_t;
	void(*__SET_ENTITY_COLLISION)(uint EntityHandle, bool Toggle) = (void(*)(uint, bool))&SET_ENTITY_COLLISION_t;
	void(*__SET_PED_AS_ENEMY)(uint PedHandle, bool unk) = (void(*)(uint, bool))&SET_PED_AS_ENEMY_t;
	void(*__SET_PED_ALERTNESS)(uint PedHandle, int Alertness) = (void(*)(uint, int))&SET_PED_ALERTNESS_t;
	void(*__TASK_COMBAT_PED)(uint PedHandle, int Target, int unk1, int unk2) = (void(*)(uint, int, int, int))&TASK_COMBAT_PED_t;
	void(*__SET_PED_KEEP_TASK)(uint Ped, bool Toggle) = (void(*)(uint, bool))&SET_PED_KEEP_TASK_t;
	void(*__SET_PED_COMBAT_RANGE)(uint Ped, float Range) = (void(*)(uint, float))&SET_PED_COMBAT_RANGE_t;
	Vector3(*__GET_ENTITY_ROTATION)(int id, bool True) = (Vector3(*)(int, bool))&GET_ENTITY_ROTATION_t;
	Vector3(*__GET_ENTITY_FORWARD_VECTOR)(int Entity) = (Vector3(*)(int))&GET_ENTITY_FORWARD_VECTOR_t;
	void(*__CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR)(int Handle) = (void(*)(int))&CLEAR_VEHICLE_CUSTOM_PRIMARY_COLOUR_t;
	void(*__CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR)(int Handle) = (void(*)(int))&CLEAR_VEHICLE_CUSTOM_SECONDARY_COLOUR_t;
	void(*__SET_VEHICLE_DOOR_OPEN)(int VehicleHandle, int Door, int Door2) = (void(*)(int, int, int))&SET_VEHICLE_DOOR_OPEN_t;
	void(*__SET_VEHICLE_DOOR_SHUT)(int VehicleHande, int Door, int Door2) = (void(*)(int, int, int))&SET_VEHICLE_DOOR_SHUT_t;
	Vector3(*__GET_GAMEPLAY_CAM_COORD)() = (Vector3(*)())&GET_GAMEPLAY_CAM_COORD_t;
	void(*__NETWORK_ADD_FRIEND)(char* PSNName) = (void(*)(char*))&NETWORK_ADD_FRIEND_t;
}
...
namespace PLAYER
{
	...
	static void SET_AIR_DRAG_MULTIPLIER_FOR_PLAYERS_VEHICLE(Player player, float multiplier) { invoke<Void>(0xF20F72E5, player, multiplier); } //  0xF20F72E5
	static void _SET_SWIM_SPEED_MULTIPLIER(Player player, float multiplier) { invoke<Void>(0xB986FF47, player, multiplier); } //  0xB986FF47
	static void SPECIAL_ABILITY_CHARGE_SMALL(Player player, BOOL p1, BOOL p2) { invoke<Void>(0x6F463F56, player, p1, p2); } //  0x6F463F56
	static void SPECIAL_ABILITY_CHARGE_MEDIUM(Player player, BOOL p1, BOOL p2) { invoke<Void>(0xAB55D8F3, player, p1, p2); } //  0xAB55D8F3
	static void SPECIAL_ABILITY_CHARGE_LARGE(Player player, BOOL p1, BOOL p2) { invoke<Void>(0xF440C04D, player, p1, p2); } //  0xF440C04D
	static void SPECIAL_ABILITY_CHARGE_CONTINUOUS(Player player, BOOL p1) { invoke<Void>(0x5FEE98A2, player, p1); } //  0x5FEE98A2
	static void SPECIAL_ABILITY_CHARGE_ABSOLUTE(Player player, int p1, BOOL p2) { invoke<Void>(0x72429998, player, p1, p2); } //  0x72429998
	...
	static Any GET_PLAYER_INVINCIBLE(Any p0, Any p1) { return invoke<Any>(0x680C90EE, p0, p1); } // 0x680C90EE
	...
	static Any GET_TIME_SINCE_LAST_ARREST(Any p0) { return invoke<Any>(0x62824EF4, p0); } // 0x62824EF4
	static Any GET_TIME_SINCE_LAST_DEATH(Any p0) { return invoke<Any>(0x24BC5AC0, p0); } // 0x24BC5AC0
...
namespace ENTITY
{
	static Vector3 GET_PED_BONE_COORDS(Ped ped, int boneId, float offsetX, float offsetY, float offsetZ) { return invoke<Vector3>(0x4579CAB1, ped, boneId, offsetX, offsetY, offsetZ); } // 0x17C07FC640E86B4E 0x4579CAB1
	...
	static Vector3 GET_ENTITY_COORDS1(int id, bool unkBool) { return invoke<Vector3>(0x1647F1CB, id, unkBool); } // 0x1647F1CB
	...
	static void APPLY_FORCE_TO_ENTITY(Entity entity, BOOL p1, float Force_X, float Force_Y, float Force_Z, float Rot_X, float Rot_Y, float Rot_Z, BOOL p8, BOOL p9, BOOL p10, BOOL p11, int p12, BOOL p13) { invoke<Vector3>(0xC1C0855A, entity, p1, Force_X, Force_Y, Force_Z, Rot_X, Rot_Y, Rot_Z, p8, p9, p10, p11, p12, p13); } // 0xC1C0855A
...
namespace VEHICLE
{
	static Entity CREATE_VEHICLE(Hash VehicleHash, float xCoord, float yCoord, float zCoord, float Heading, BOOL networkHandle, BOOL vehiclehandle) { return invoke<Entity>(0xDD75460A, VehicleHash, xCoord, yCoord, zCoord, Heading, networkHandle, vehiclehandle); } // 0xDD75460A
	//static int CREATE_VEHICLE1(int VehicleHash, Vector3 *Pos, float Heading, int One, int Zero) { return invoke<int>(0xDD75460A, VehicleHash,*Pos,Heading,One,Zero); } 
	static uint CREATE_VEHICLE(Hash VehicleHash, Vector3 xyz, float Heading, BOOL networkHandle, BOOL vehiclehandle) { return invoke<uint>(0xDD75460A, VehicleHash,xyz , Heading, networkHandle, vehiclehandle); } // 0xDD75460A
...
namespace OBJECT
{
	...
	static Any CREATE_AMBIENT_PICKUP_ALT(Hash AmbientHash, float XCoord, float YCoord, float ZCoord, int p4, int amount, int modelHash, BOOL p7, BOOL p8) { return invoke<Any>(0xE51B4C5A, AmbientHash, XCoord, YCoord, ZCoord, p4, amount, modelHash, p7, p8); } // 0xE51B4C5A
...
namespace GAMEPLAY
{
	static Vector3 _GET_GAMEPLAY_CAM_ROT(Any p0) { return invoke<Vector3>(0x1FFBEFC5, p0); } // 0x5B4E4C817FCC2DFB 0x1FFBEFC5
	...
	static void CLEAR_AREA(Any p0, Any p1, Any p2, float Radius, bool unk) { invoke<Void>(0x854E9AB8, p0, p1, p2, Radius, unk); } // 0x854E9AB8
	...
	static void CLEAR_AREA_OF_VEHICLES(Any p0, Any p1, Any p2, float Radius) { invoke<Void>(0x63320F3C, p0, p1, p2, Radius); } // 0x63320F3C
	...
	static void CLEAR_AREA_OF_OBJECTS(Any p0, Any p1, Any p2, float Radius) { invoke<Void>(0xBB720FE7, p0, p1, p2, Radius); } // 0xBB720FE7
	static void CLEAR_AREA_OF_PEDS(Any p0, Any p1, Any p2, float Radius) { invoke<Void>(0x25BE7FA8, p0, p1, p2, Radius); } // 0x25BE7FA8
	static void CLEAR_AREA_OF_COPS(Any p0, Any p1, Any p2, float Radius) { invoke<Void>(0x95C53824, p0, p1, p2,  Radius); } // 0x95C53824
	static void CLEAR_AREA_OF_PROJECTILES(Any p0, Any p1, Any p2, float Radius) { invoke<Void>(0x18DB5434, p0, p1, p2, Radius); } // 0x18DB5434
	...
	static void Superjump_Addr(Player player) { invoke<Void>(0x5EDB90, player); } // 0x5EDB90
...
namespace STREAMING
{
	static Any REQUEST_NAMED_PTFX_ASSET(char* fxName) { return invoke<Any>(0xCFEA19A9); } // 0xCFEA19A9
...
namespace UI
{
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char* picName1, char* picName2, BOOL flash, int iconType1, char* sender, char* subject, float duration, char* clanTag, int iconType2) { return invoke<int>(0xDEB491C8, picName1, picName2, flash, iconType1, sender, subject, duration, clanTag, iconType2); } // 0x531B84E7DA981FB6 0xDEB491C8
	static void _SET_TEXT_COMPONENT_FORMAT(char* inputType) { invoke<Void>(0xB245FC10, inputType); }
	static void _DRAW_TOOLTIP_NOTIFICATION(Any p0, BOOL loop, BOOL beep, int shape) { invoke<Void>(0xB59B530D, p0,loop, beep, shape); }
...
namespace GRAPHICS
{
	...
	static Any _SET_PTFX_ASSET_NEXT_CALL(char* name) { return invoke<Any>(0x9C720B61); } // 0x9C720B61
...
namespace FIRE
{
	...
	static void ADD_EXPLOSION1(Vector3 xyz, int ExplosionType, float ExplosionRadius, BOOL isAudible, BOOL isVisible, float CameraShake) { invoke<Void>(0x10AF5258, xyz, ExplosionType, ExplosionRadius, isAudible, isVisible, CameraShake); } // 0x10AF5258
	static void ADD_OWNED_EXPLOSION1(Ped PedHandle, float*xyz, int ExlosionType, float ExplosionRadius, BOOL IsAudible, BOOL IsVisible, float CamerShake) { invoke<Void>(0x27EE0D67, PedHandle, xyz, ExlosionType, ExplosionRadius, IsAudible, IsVisible, CamerShake); } // 0x27EE0D67
...
namespace NETWORK
{
	...
	static int NETWORK_GET_HOST_OF_SCRIPT(char *gamemode, Any p1, Any p2) { return invoke<int>(0x9C95D0BB, gamemode, p1, p2); } // 0x9C95D0BB
